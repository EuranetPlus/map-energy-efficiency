export const config = {
	mapTitle: 'energy-efficiency', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-energy-efficiency.vercel.app', // The url provided when deploying the map on Vercel
